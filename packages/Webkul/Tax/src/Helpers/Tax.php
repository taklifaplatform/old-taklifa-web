...
class Tax
{
    ...
    public static function isTaxInclusive(): bool
    {
     ...
     /**
     * Calculate tax based on total amount and tax percentage.
     */
    public static function calculateTax(float $totalAmount, float $taxPercent): float
    {
        $taxAmount = round(($totalAmount * $taxPercent / 100), self::TAX_AMOUNT_PRECISION);
        return $taxAmount;
    }
