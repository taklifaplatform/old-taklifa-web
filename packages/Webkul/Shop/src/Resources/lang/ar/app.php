...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© حقوق الطبع والنشر 2016 - :current_year، ZIX DEV. جميع الحقوق محفوظة.',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                ...
                'header-title' => 'احصل بسهولة على عرض السعر المجاني الخاص بمنزلك او مكتبك او مشروعك التجاري',
                'construction' => 'مشاريع البناء والتشطيب',
        ...
        'products' => [
            'card' => [
                ...
                'sale'                   => 'تخفيض',
                'show-quote'             => 'عرض الاسعار',
                'add-to-quote'            => 'أضف إلى عرض السعر',
                'calculate'             => 'احسب',
            ],
    ...
    'checkout' => [
        ...
        'quote' => [
            ...
            'inactive'                  => 'تم إلغاء تنشيط المنتج وبالتالي إزالته من عرض السعر.',
            'inventory-warning'         => 'الكمية المطلوبة غير متوفرة، يرجى المحاولة مرة أخرى لاحقًا.',
            'item-add-to-quote'          => 'تمت إضافة العنصر بنجاح',
            ...
            'rule-applied'              => 'تم تطبيق قاعدة عرض السعر',
            'select-hourly-duration'    => 'حدد مدة الفترة بساعة واحدة.',
            'success-remove'            => 'تمت إزالة العنصر بنجاح من عرض السعر.',
            ...
            'index' => [
                ...
                'empty-product'            => 'ليس لديك منتج في عرض السعر الخاص بك.',
                'home'                     => 'الصفحة الرئيسية',
                ...
                'remove'                   => 'إزالة',
                'remove-selected-success'  => 'تم إزالة العناصر المحددة بنجاح من عرض السعر.',
                'see-details'              => 'رؤية التفاصيل',
                'select-all'               => 'تحديد الكل',
                'select-quote-item'         => 'تحديد عنصر العربة',
                'tax'                      => 'الضريبة',
                'total'                    => 'المجموع',
                'update-quote'              => 'تحديث عرض السعر',
            ...
            'mini-quote' => [
                ...
                'empty-quote'           => 'سلة عرض السعر الخاص بك فارغه',
                'offer-on-orders'      => 'احصل على خصم يصل إلى 30٪ على طلبك الأول',
                'remove'               => 'إزالة',
                'see-details'          => 'رؤية التفاصيل',
                'shopping-quote'        => 'عرض السعر',
                'subtotal'             => 'المجموع الفرعي',
                'view-quote'            => 'عرض السعر',
            ],
            ...
            'summary' => [
                ...
                'proceed-to-checkout' => 'طلب عرض سعر',
        ...
        'cart' => [
            ...
            'index' => [
                ...
                'calculate-cost'        => 'حساب التكلفة',
                "construction-calculator" => "حاسبة البناء",
                "land-area"            => "مساحة الأرض",
                "number-of-floors"     => "عدد الأدوار",
                "one-floor"            => "دور واحد",
                "two-floors"           => "دورين",
                "two-floors-with-an-annex" => "دورين مع ملحق",
                "basement"            => "القبو",
                "basement-area"       => "مساحة القبو",
                "calculate-the-cost"   => "احسب التكلفة",
                "please-enter" => "الرجاء إدخال مساحة أرض صحيحة بين 200 م و 2500 م.",
                "basement-error"  => "الرجاء إدخال مساحة القبو.",
                "select-number-floors" => "الرجاء اختيار عدد الأدوار.",
                "construction-cost" => "تكلفة البناء",
                "calculate-again" => "احسب مجددا",
                "construction-areas" => "مسطحات البناء",
                "ground-floor" => "الدور الأرضي",
                "the-first-floor" => "الدور الأول",
                "appendix" => "الملحق",
                "the-wall" => "السور",
                "water-tank" => "خزان المياه",
                "septic-tank" => "خزان الصرف",
                "the-pool" => "المسبح",
                "total-cons" => "الإجمالي",
                "costs" => "التكاليف",
                "skeleton-construction" => "بناء العظم",
                "finishing" => "التشطيب",
