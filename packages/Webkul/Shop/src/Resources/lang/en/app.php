...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2016 - :current_year, ZIX DEV. All rights reserved.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2016 - :current_year, ZIX DEV. All rights reserved.',
                'locale'                 => 'Locale',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'index' => [
                ...
                "quote"                  => "Quote",
                'empty-quote'             => 'Your quote is empty',
                'name'                    => 'Name',
                'region'                  => 'Region',
                ...
                "two-floors-with-an-annex" => "Two floors with an annex",
                "basement"                => "Basement",
                "basement-area"          => "Basement Area",
                "calculate-the-cost"     => "Calculate the cost",
                "please-enter" => "Please enter a valid land area between 200m and 2500m.",
                "basement-error" => "Please enter the basement area",
                "select-number-floors" => "Please select the number of floors.",
                "construction-cost" => "Construction Cost",
                "calculate-again" => "Calculate Again",
                "construction-areas" => "Construction Areas",
