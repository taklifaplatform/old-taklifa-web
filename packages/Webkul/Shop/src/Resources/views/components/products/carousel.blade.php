...
@pushOnce('scripts')
    ...
    >
        <div
            class="container mt-8 max-lg:px-8 max-sm:mt-6"
            v-if="! isLoading && products.length"
        >
            <div class="flex justify-between">
                <div class="w-[100px] max-md:hidden" />
                <h2
                    class="text-2xl font-dmserif max-sm:text-2xl"
                    v-text="title"
                >
                </h2>

                <div class="flex gap-8 justify-between items-center w-[100px]">
                    <span
            ...
            <div
                ref="swiperContainer"
                class="flex max-md:gap-4 gap-8 [&>*]:flex-[0] mt-4 overflow-auto scroll-smooth scrollbar-hide max-sm:mt-5"
            >
                <x-shop::products.card
                    class="min-w-[291px] max-md:min-w-[150px] max-lg:min-w-[150px]"
