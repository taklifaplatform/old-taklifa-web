...
<footer class="relative mt-9 bg-lightOrange max-sm:mt-8 min-w-[304px] max-w-full">
    ...
    <div class="flex gap-x-6 gap-y-8 justify-between p-[60px] max-1060:flex-wrap max-1060:flex-col-reverse max-sm:px-4">
        ...
        @if (core()->getConfigData('customer.settings.newsletter.subscription'))
            <div class="grid gap-2.5">
                <p class="max-w-[288px] leading-[45px] text-3xl italic text-navyBlue" role="heading" aria-level="2">
                ...
                <x-shop::form :action="route('shop.subscription.store')" class="mt-2.5 rounded max-sm:mt-8 relative ">
                    <div class="relative w-full">
                        ...
                        <button type="submit"
                            class="absolute flex items-center top-2 w-max px-5 py-3.5 bg-white rounded-xl text-xs font-medium rtl:left-2 ltr:right-2">
        ...
        {{-- @if (core()->getConfigData('customer.settings.newsletter.subscription'))
            <div class="grid gap-2.5">
                ...
                <x-shop::form :action="route('shop.subscription.store')" class="mt-2.5 rounded max-sm:mt-8">
                    <div class="relative w-full">
                        <x-shop::form.control-group.control type="email"
                            class="blockw-[420px] max-w-full px-5 py-5 p-28 bg-[#F1EADF] border-[2px] border-[#E9DECC] rounded-xl text-xs font-medium max-1060:w-full"
                            name="email" rules="required|email" label="Email" :aria-label="trans('shop::app.components.layouts.footer.email')"
