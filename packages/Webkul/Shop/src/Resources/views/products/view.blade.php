    ...
    <div class="1180:mt-20">
        <x-shop::tabs position="center">
            ...
            @if (count($attributeData))
                <x-shop::tabs.item class="container mt-[60px] !p-0 max-1180:hidden" :title="trans('shop::app.products.view.additional-information')" :is-selected="false">
                    <div class="container mt-[60px] max-1180:px-5">
                            ...
                            @foreach ($customAttributeValues as $customAttributeValue)
                                @if (!empty($customAttributeValue['value']))
                                    ...
                                    @elseif ($customAttributeValue['type'] == 'image')
                                        <a href="{{ Storage::url($product[$customAttributeValue['code']]) }}"
                                            download="{{ $customAttributeValue['label'] }}">
                                            <img class="h-5 w-5 min-h-5 min-w-5"
                            ...
                            <div class="max-w-[590px] relative max-1180:w-full max-1180:max-w-full max-1180:px-5">
                                ...
                                <div class="flex gap-4 max-w-[470px] mt-8">
                                    ...
                                    @if ($product->getTypeInstance()->showQuantityBox())
                                        ...
                                        <div class="flex gap-x-2.5 border rounded-[10px] border-navyBlue py-1.5 px-2.5 max-md:px-2 max-md:py-1 w-full max-w-full justify-between">
                                            <button
                                                type="button"
                                                class="px-1.5 py-1 bg-white rounded"
                                            ...
                                            <input
                                                type="number"
                                                name="quantity"
                                                class="w-11 text-center no-arrows"
                                                v-model="quantity"
                                                min="1"
            ...
            app.component('v-product', {
                ...
                methods: {
                    ...
                    addToCart(params) {
                        ...
                        this.$axios.post('{{ route('shop.api.checkout.quote.store') }}', formData, {
                                headers: {
