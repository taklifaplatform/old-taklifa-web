    ...
    [
        ...
        'fields' => [
            [
                ...
                'name'  => 'enable_product_flag',
                'title' => 'marketplace::app.admin.system.settings.general.enable-product-flag',
                'type'  => 'boolean',
            ], [
                'name'  => 'guest_can_product_flag',
                'title' => 'marketplace::app.admin.system.settings.general.guest-can-product-flag',
                'type'  => 'boolean',
            ], [
                'name'  => 'custom_product_flag_reason',
                'title' => 'marketplace::app.admin.system.settings.general.custom-product-flag-reason',
                'type'  => 'boolean',
            ], [
                'name'          => 'seller_can_assign_product',
                'title'         => 'marketplace::app.admin.system.settings.general.seller-can-assign-product',
                'type'          => 'boolean',
                'default'       => true,
            ], [
                'name'          => 'seller_can_create_product',
                'title'         => 'marketplace::app.admin.system.settings.general.seller-can-create-product',
                'type'          => 'boolean',
                'default'       => true,
            ], [
                ...
                'name'          => 'street_lines',
                'title'         => 'marketplace::app.admin.system.settings.general.line-in-a-street-address',
                'info'          => '"Lines in a street address" refer to individual segments of an address, often separated by commas, providing location information such as house number, street, city, and more.',
                'type'          => 'text',
                'validation'    => 'required|integer|between:1,4',
                'channel_based' => true,
                'locale_based'  => false,
            ],
        ],
