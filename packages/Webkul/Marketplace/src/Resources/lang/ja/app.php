...
return [
        ...
        'system' => [
            ...
            'settings' => [
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'カスタム商品の通報理由',
                    'description'                => 'マーケットプレイス、販売者アクセス可能な機能、およびマーケットプレイスのグローバル手数料の承認を設定します。',
                    'enable-product-flag'        => '商品の通報を有効にする',
                    'featured-product'           => '注目商品を表示',
                    'guest-can-product-flag'     => 'ゲストが商品を通報できる',
                    'line-in-a-street-address'   => '通りの住所の行',
                    'minimum-order-amount'       => '最低注文金額を有効にする',
                    'new-product'                => '新着商品を表示',
                    'product-approval-required'  => '商品の承認が必要',
                    'seller-approval-required'   => '売り手の承認が必要',
                    'status'                     => 'ステータス',
                    'seller-can-assign-product'  => '売り手は商品を割り当てることができます',
                    'seller-can-create-product'  => '売り手は商品を作成することができます',
                    'title'                      => '一般',
                ],
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'create' => [
                    ...
                    'save-btn' => '理由を保存',
                    'status'   => 'ステータス',
                    'success'  => '商品の通報理由が正常に作成されました。',
                    'title'    => '理由を作成',
                ],

                'edit' => [
                    'success' => '商品の通報理由が正常に更新されました。',
                    'title'   => '理由を更新',
                ],

                'delete-failed'  => '商品の通報理由の削除に失敗しました！',
                'delete-success' => '商品の通報理由が正常に削除されました。',
                'update-success' => '商品の通報理由が正常に更新されました。',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report' => [
                'already-reported' => 'すでに通報済み',
                'email'            => 'メール',
                'name'             => '名前',
                'reason'           => '理由',
                'report-issue'     => '問題を通報',
                'report-product'   => '商品を通報',
                'submit'           => '送信',
            ],

            'report-success'           => '商品が正常に通報されました。',
            'already-product-reported' => '商品はすでに通報されています。',
        ],
