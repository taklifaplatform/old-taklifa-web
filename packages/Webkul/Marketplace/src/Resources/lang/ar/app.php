...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'       => 'إصدار التطبيقv2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'سبب مخصص لعلامة المنتج',
                    'description'                => 'تعيين الموافقة لسوق البيع، وميزات الوصول للبائع، وعمولة السوق العالمية.',
                    'enable-product-flag'        => 'تفعيل علامة المنتج',
                    'featured-product'           => 'عرض المنتج المميز',
                    'guest-can-product-flag'     => 'يمكن للضيوف وضع علامة على المنتج',
                    'line-in-a-street-address'   => 'الأسطر في عنوان الشارع',
                    ...
                    'seller-can-assign-product'  => 'يمكن للبائع تعيين منتج',
                    'seller-can-create-product'  => 'يمكن للبائع إنشاء منتج',
                    'status'                     => 'الحالة',
                    'title'                      => 'عام',
                ],
        ...
        'acl' => [
            ...
            'products'             => 'المنتجات',
            'product-flag-reasons' => 'أسباب علامة المنتج',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'أسباب علامة المنتج',

                'create' => [
                    'reason'   => 'السبب',
                    'save-btn' => 'حفظ السبب',
                    'status'   => 'الحالة',
                    'success'  => 'تم إنشاء سبب علامة المنتج بنجاح.',
                    'title'    => 'إنشاء سبب',
                ],

                'edit' => [
                    'success' => 'تم تحديث سبب علامة المنتج بنجاح.',
                    'title'   => 'تحديث السبب',
                ],

                'delete-failed'  => 'فشل حذف سبب علامة المنتج!',
                'delete-success' => 'تم حذف سبب علامة المنتج بنجاح.',
                'update-success' => 'تم تحديث سبب علامة المنتج بنجاح.',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report' => [
                'already-reported' => 'تم الإبلاغ عنه بالفعل',
                'email'            => 'البريد الإلكتروني',
                'name'             => 'الاسم',
                'reason'           => 'السبب',
            ...
            'report-success'           => 'تم الإبلاغ عن المنتج بنجاح.',
            'already-product-reported' => 'تم الإبلاغ عن المنتج بالفعل.',
        ],
                ...
                'users' => [
                    'index' => [
                        ...
                        'datagrid' => [
                            ...
                            'email'       => 'البريد الإلكتروني',
                            'flags'       => 'العلامات',
                            'flags-value' => 'إجمالي العلامات - :count',
                            'id'          => 'الرقم التعريفي',
                            'id-value'    => 'ID - :id',
                            'name'        => 'الاسم',
                            'permission'  => 'الصلاحية',
