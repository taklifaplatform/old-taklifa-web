...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'        => 'অ্যাপ সংস্করণv2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'কাস্টম পণ্য পতাকা কারণ',
                    'description'                => 'মার্কেটপ্লেস, বিক্রেতা অ্যাক্সেসযোগ্য বৈশিষ্ট্য এবং মার্কেটপ্লেস গ্লোবাল কমিশনের অনুমোদন সেট করুন।',
                    'enable-product-flag'        => 'পণ্য পতাকা সক্ষম করুন',
                    'featured-product'           => 'বৈশিষ্ট্যযুক্ত পণ্য দেখান',
                    'guest-can-product-flag'     => 'অতিথি পণ্য পতাকা করতে পারে',
                    'line-in-a-street-address'   => 'রাস্তার ঠিকানায় লাইনে',
                    ...
                    'seller-can-assign-product'  => 'বিক্রেতা পণ্য নির্ধারণ করতে পারে',
        ...
        'acl' => [
            ...
            'products'             => 'পণ্যসমূহ',
            'product-flag-reasons' => 'পণ্য পতাকা কারণ',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'পণ্য পতাকা কারণ',

                'create' => [
                    'reason'   => 'কারণ',
                    'save-btn' => 'কারণ সংরক্ষণ করুন',
                    'status'   => 'স্ট্যাটাস',
                    'success'  => 'পণ্য পতাকা কারণ সফলভাবে তৈরি হয়েছে।',
                    'title'    => 'কারণ তৈরি করুন',
                ],

                'edit' => [
                    'success' => 'পণ্য পতাকা কারণ সফলভাবে আপডেট হয়েছে।',
                    'title'   => 'কারণ আপডেট করুন',
                ],

                'delete-failed'  => 'পণ্য পতাকা কারণ মুছে ফেলা ব্যর্থ হয়েছে!',
                'delete-success' => 'পণ্য পতাকা কারণ সফলভাবে মুছে ফেলা হয়েছে।',
                'update-success' => 'পণ্য পতাকা কারণ সফলভাবে আপডেট হয়েছে।',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report' => [
                'already-reported' => 'ইতিমধ্যেই রিপোর্ট করা হয়েছে',
                'email'            => 'ইমেইল',
                'name'             => 'নাম',
                'reason'           => 'কারণ',
            ...
            'report-success'           => 'পণ্য সফলভাবে রিপোর্ট করা হয়েছে।',
            'already-product-reported' => 'পণ্য ইতিমধ্যেই রিপোর্ট করা হয়েছে।',
        ],
        ...
        'sellers' => [
            ...
            'account' => [
                ...
                'acl' => [
                    ...
                    'seller-reviews'  => 'বিক্রেতার রিভিউ',
                    'shipment'        => 'প্রেরণ',
                    'transactions'    => 'লেনদেন',
                    'view'            => 'দেখুন',
                ],
