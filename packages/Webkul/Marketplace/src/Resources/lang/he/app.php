...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'       => 'גרסת האפליקציהv2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'סיבה מותאמת אישית לסימון מוצר',
                    'description'                => 'קבע את האישור לשוק, לתכונות הזמינות למוכר ולעמלת השוק הגלובלית.',
                    'enable-product-flag'        => 'אפשר סימון מוצר',
                    'featured-product'           => 'הצג מוצר מומלץ',
                    'guest-can-product-flag'     => 'אורחים יכולים לסמן מוצרים',
                    'line-in-a-street-address'   => 'שורות בכתובת רחוב',
        ...
        'acl' => [
            ...
            'products'             => 'מוצרים',
            'product-flag-reasons' => 'סיבות לסימון מוצר',
        ...
        'product-flag-reasons' => [
            'index' => [
                'create-btn' => 'צור סיבה',
                'title'      => 'סיבות לסימון מוצר',

                'create' => [
                    'reason'   => 'סיבה',
                    'save-btn' => 'שמור סיבה',
                    'status'   => 'סטטוס',
                    'success'  => 'סיבת הסימון למוצר נוצרה בהצלחה.',
                    'title'    => 'צור סיבה',
                ],

                'edit' => [
                    'success' => 'סיבת הסימון למוצר עודכנה בהצלחה.',
                    'title'   => 'עדכן סיבה',
                ],

                'delete-failed'  => 'מחיקת סיבת הסימון למוצר נכשלה!',
                'delete-success' => 'סיבת הסימון למוצר נמחקה בהצלחה.',
                'update-success' => 'סיבת הסימון למוצר עודכנה בהצלחה.',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report-success'           => 'המוצר דווח בהצלחה.',
            'already-product-reported' => 'המוצר כבר דווח.',
        ],
