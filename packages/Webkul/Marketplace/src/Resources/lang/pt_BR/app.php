...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'       => 'Versão do Aplicativov2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'Motivo Personalizado de Sinalização de Produtos',
                    ...
                    'enable-product-flag'        => 'Habilitar Sinalização de Produtos',
                    'featured-product'           => 'Mostrar Produto em Destaque',
                    'guest-can-product-flag'     => 'Convidados Podem Sinalizar Produtos',
                    'line-in-a-street-address'   => 'Linhas em um Endereço de Rua',
                    ...
                    'status'                     => 'Status',
                    'seller-can-assign-product'  => 'O vendedor pode atribuir produtos',
                    'seller-can-create-product'  => 'O vendedor pode criar produtos',
                    'title'                      => 'Geral',
                ],
        ...
        'acl' => [
            ...
            'products'             => 'Produtos',
            'product-flag-reasons' => 'Motivos de Sinalização de Produtos',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'Motivos de Sinalização de Produtos',

                'create' => [
                    'reason'   => 'Motivo',
                    'save-btn' => 'Salvar Motivo',
                    'status'   => 'Status',
                    'success'  => 'Motivo de sinalização de produto criado com sucesso.',
                    'title'    => 'Criar Motivo',
                ],

                'edit' => [
                    'success' => 'Motivo de sinalização de produto atualizado com sucesso.',
                    'title'   => 'Atualizar Motivo',
                ],

                'delete-failed'  => 'Falha ao excluir motivo de sinalização de produto!',
                'delete-success' => 'Motivo de sinalização de produto excluído com sucesso.',
                'update-success' => 'Motivo de sinalização de produto atualizado com sucesso.',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report' => [
                'already-reported' => 'Já reportado',
                'email'            => 'E-mail',
                'name'             => 'Nome',
                'reason'           => 'Motivo',
                'report-issue'     => 'Reportar problema',
                'report-product'   => 'Reportar Produto',
                'submit'           => 'Enviar',
            ],

            'report-success'           => 'Produto reportado com sucesso.',
            'already-product-reported' => 'Produto já reportado.',
        ],
                ...
                'users' => [
                    'index' => [
                        ...
                        'datagrid' => [
                            ...
                            'email'       => 'Email',
                            'flags'       => 'Sinalizadores',
                            'flags-value' => 'Total de sinalizadores - :count',
                            'id'          => 'ID',
                            'id-value'    => 'ID - :id',
                            'name'        => 'Nome',
