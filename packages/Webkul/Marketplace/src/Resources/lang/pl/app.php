...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'       => 'Wersja Aplikacjiv2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'Niestandardowy powód oznaczania produktu',
                    'description'                => 'Ustaw zatwierdzenie na Marketplace, dostępne funkcje dla sprzedawcy i globalną prowizję Marketplace.',
                    'enable-product-flag'        => 'Włącz oznaczanie produktów',
                    'featured-product'           => 'Pokaż Wybrane Produkty',
                    'guest-can-product-flag'     => 'Goście mogą oznaczać produkty',
                    'line-in-a-street-address'   => 'Linie w adresie ulicy',
                    ...
                    'seller-can-create-product'  => 'Sprzedawca może stworzyć produkt',
                    'title'                      => 'Ogólne',
                ],
        ...
        'acl' => [
            ...
            'products'             => 'Produkty',
            'product-flag-reasons' => 'Powody oznaczania produktów',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'Powody oznaczania produktów',

                'create' => [
                    'reason'   => 'Powód',
                    'save-btn' => 'Zapisz Powód',
                    'status'   => 'Status',
                    'success'  => 'Powód oznaczania produktu został pomyślnie utworzony.',
                    'title'    => 'Utwórz Powód',
                ],

                'edit' => [
                    'success' => 'Powód oznaczania produktu został pomyślnie zaktualizowany.',
                    'title'   => 'Zaktualizuj Powód',
                ],

                'delete-failed'  => 'Usunięcie powodu oznaczania produktu nie powiodło się!',
                'delete-success' => 'Powód oznaczania produktu został pomyślnie usunięty.',
                'update-success' => 'Powód oznaczania produktu został pomyślnie zaktualizowany.',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report-success'           => 'Produkt został pomyślnie zgłoszony.',
            'already-product-reported' => 'Produkt jest już zgłoszony.',
        ],
                ...
                'users' => [
                    'index' => [
                        ...
                        'datagrid' => [
                            ...
                            'email'       => 'Email',
                            'flags'       => 'Flagi',
                            'flags-value' => 'Łączna liczba flag - :count',
                            'id'          => 'ID',
                            'id-value'    => 'ID - :id',
                            'name'        => 'Imię',
