...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => '自定义产品标记原因',
                    'description'                => '设置市场、卖家可访问功能和市场全球佣金的批准。',
                    'enable-product-flag'        => '启用产品标记',
                    'featured-product'           => '显示特色产品',
                    'guest-can-product-flag'     => '访客可以标记产品',
                    'line-in-a-street-address'   => '街道地址中的行',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'delete-failed'  => '产品标记原因删除失败！',
                'delete-success' => '产品标记原因已成功删除。',
                'update-success' => '产品标记原因已成功更新。',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report-success'           => '产品已成功报告。',
            'already-product-reported' => '产品已被报告。',
        ],
