...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'       => 'نسخه اپلیکیشنv2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'دلیل سفارشی برای علامت‌گذاری محصول',
                    'description'                => 'تنظیم تأیید برای بازار، ویژگی های قابل دسترس برای فروشنده و کمیسیون جهانی بازار.',
                    'enable-product-flag'        => 'فعال کردن علامت‌گذاری محصول',
                    'featured-product'           => 'نمایش محصول ویژه',
                    'guest-can-product-flag'     => 'مهمانان می‌توانند علامت‌گذاری کنند',
                    'line-in-a-street-address'   => 'خطوط در آدرس خیابان',
                    ...
                    'seller-can-assign-product'  => 'فروشنده می‌تواند محصول را اختصاص دهد',
        ...
        'acl' => [
            ...
            'products'             => 'محصولات',
            'product-flag-reasons' => 'دلایل علامت‌گذاری محصول',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'دلایل علامت‌گذاری محصول',

                'create' => [
                    'reason'   => 'دلیل',
                    'save-btn' => 'ذخیره دلیل',
                    'status'   => 'وضعیت',
                    'success'  => 'دلیل علامت‌گذاری محصول با موفقیت ایجاد شد.',
                    'title'    => 'ایجاد دلیل',
                ],

                'edit' => [
                    'success' => 'دلیل علامت‌گذاری محصول با موفقیت به‌روزرسانی شد.',
                    'title'   => 'به‌روزرسانی دلیل',
                ],

                'delete-failed'  => 'حذف دلیل علامت‌گذاری محصول با شکست مواجه شد!',
                'delete-success' => 'دلیل علامت‌گذاری محصول با موفقیت حذف شد.',
                'update-success' => 'دلیل علامت‌گذاری محصول با موفقیت به‌روزرسانی شد.',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report-success'           => 'محصول با موفقیت گزارش شد.',
            'already-product-reported' => 'محصول قبلاً گزارش شده است.',
        ],
        ...
        'sellers' => [
            'profile' => [
                ...
                'reviews' => [
                    ...
                    'write-review'     => 'نوشتن نقد و بررسی',
                ],
                ...
                'users' => [
                    'index' => [
                        ...
                        'datagrid' => [
                            ...
                            'email'       => 'ایمیل',
                            'flags'       => 'پرچم‌ها',
                            'flags-value' => 'تعداد کل پرچم‌ها - :count',
                            'id'          => 'شناسه',
                            'id-value'    => 'شناسه - :id',
                            'name'        => 'نام',
                            'permission'  => 'دسترسی',
