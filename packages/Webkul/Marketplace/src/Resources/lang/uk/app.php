...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'       => 'Версія додаткуv2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'Спеціальна причина маркування продукту',
                    'description'                => 'Встановити схвалення для Ринку, доступних функцій Продавця та Глобальної комісії Ринку.',
                    'enable-product-flag'        => 'Увімкнути маркування продукту',
                    'featured-product'           => 'Показувати Рекомендований Товар',
                    'guest-can-product-flag'     => 'Гість може маркувати продукт',
                    'line-in-a-street-address'   => 'Рядки у вуличній адресі',
                    ...
                    'status'                     => 'Статус',
                    'seller-can-assign-product'  => 'Продавець може призначати продукти',
                    'seller-can-create-product'  => 'Продавець може створювати продукти',
                    'title'                      => 'Загальні',
                ],
        ...
        'acl' => [
            ...
            'products'             => 'Товари',
            'product-flag-reasons' => 'Причини маркування продукту',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'Причини маркування продукту',

                'create' => [
                    'reason'   => 'Причина',
                    'save-btn' => 'Зберегти причину',
                    'status'   => 'Статус',
                    'success'  => 'Причина маркування продукту успішно створена.',
                    'title'    => 'Створити причину',
                ],

                'edit' => [
                    'success' => 'Причина маркування продукту успішно оновлена.',
                    'title'   => 'Оновити причину',
                ],

                'delete-failed'  => 'Не вдалося видалити причину маркування продукту!',
                'delete-success' => 'Причина маркування продукту успішно видалена.',
                'update-success' => 'Причина маркування продукту успішно оновлена.',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report-success'           => 'Продукт успішно повідомлено.',
            'already-product-reported' => 'Продукт вже повідомлено.',
        ],
        ...
        'sellers' => [
            ...
            'account' => [
                ...
                'acl' => [
                    ...
                    'payment-request' => 'Запит на оплату',
                    'print'           => 'Друк',
                    'print-invoice'   => 'Друк рахунку-фактури',
                    'product-reviews' => 'Відгуки про продукти',
                    'products'        => 'Продукти',
                    'seller-info'     => 'Інформація про продавця',
                    'seller-reviews'  => 'Відгуки про продавця',
                ...
                'users' => [
                    'index' => [
                        ...
                        'datagrid' => [
                            ...
                            'email'       => 'Електронна пошта',
                            'flags'       => 'Прапори',
                            'flags-value' => 'Загальна кількість прапорів - :count',
                            'id'          => 'ID',
                            'id-value'    => 'ID - :id',
                            'name'        => 'Ім\'я',
                            'permission'  => 'Дозвіл',
