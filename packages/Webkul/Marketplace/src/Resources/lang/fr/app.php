...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'       => 'Version de l\'applicationv2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'Raison Personnalisée pour le Signalement de Produit',
                    ...
                    'enable-product-flag'        => 'Activer le Signalement de Produit',
                    'featured-product'           => 'Afficher le produit en vedette',
                    'guest-can-product-flag'     => 'Les Invités Peuvent Signaler des Produits',
                    'line-in-a-street-address'   => 'Lignes dans une adresse de rue',
        ...
        'acl' => [
            ...
            'products'             => 'Produits',
            'product-flag-reasons' => 'Raisons de Signalement de Produit',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'Raisons de Signalement de Produit',

                'create' => [
                    'reason'   => 'Raison',
                    'save-btn' => 'Enregistrer la Raison',
                    'status'   => 'Statut',
                    'success'  => 'La raison de signalement du produit a été créée avec succès.',
                    'title'    => 'Créer une Raison',
                ],

                'edit' => [
                    'success' => 'La raison de signalement du produit a été mise à jour avec succès.',
                    'title'   => 'Mettre à jour la Raison',
                ],

                'delete-failed'  => 'Échec de la suppression de la raison de signalement du produit !',
                'delete-success' => 'La raison de signalement du produit a été supprimée avec succès.',
                'update-success' => 'La raison de signalement du produit a été mise à jour avec succès.',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report-success'           => 'Produit signalé avec succès.',
            'already-product-reported' => 'Produit déjà signalé.',
        ],
                ...
                'users' => [
                    'index' => [
                        ...
                        'datagrid' => [
                            ...
                            'email'       => 'Email',
                            'flags'       => 'Indicateurs',
                            'flags-value' => 'Total des indicateurs - :count',
                            'id'          => 'ID',
                            'id-value'    => 'ID - :id',
                            'name'        => 'Nom',
