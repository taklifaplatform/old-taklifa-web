...
return [
    'admin' => [
        'system' => [
            ...
            'settings' => [
                'app-version'       => 'Версия приложенияv2.2.2',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'Пользовательская Причина Пометки Продукта',
                    'description'                => 'Установите одобрение для Маркетплейса, доступные функции для продавца и глобальную комиссию Маркетплейса.',
                    'enable-product-flag'        => 'Включить Пометку Продуктов',
                    'featured-product'           => 'Показывать рекламируемый товар',
                    'guest-can-product-flag'     => 'Гости Могут Помечать Продукты',
                    'line-in-a-street-address'   => 'Строки в уличном адресе',
                    ...
                    'status'                     => 'Статус',
                    'seller-can-assign-product'  => 'Продавец может назначать продукты',
                    'seller-can-create-product'  => 'Продавец может создавать продукты',
                    'title'                      => 'Общее',
                ],
        ...
        'acl' => [
            ...
            'products'             => 'Товары',
            'product-flag-reasons' => 'Причины Пометки Продуктов',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'Причины Пометки Продуктов',

                'create' => [
                    'reason'   => 'Причина',
                    'save-btn' => 'Сохранить Причину',
                    'status'   => 'Статус',
                    'success'  => 'Причина пометки продукта успешно создана.',
                    'title'    => 'Создать Причину',
                ],

                'edit' => [
                    'success' => 'Причина пометки продукта успешно обновлена.',
                    'title'   => 'Обновить Причину',
                ],

                'delete-failed'  => 'Не удалось удалить причину пометки продукта!',
                'delete-success' => 'Причина пометки продукта успешно удалена.',
                'update-success' => 'Причина пометки продукта успешно обновлена.',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report-success'           => 'Продукт успешно сообщен.',
            'already-product-reported' => 'Продукт уже был сообщен.',
        ],
        ...
        'sellers' => [
            ...
            'account' => [
                ...
                'acl' => [
                    ...
                    'print'           => 'Печать',
                    'print-invoice'   => 'Печать счета-фактуры',
                ...
                'users' => [
                    'index' => [
                        ...
                        'datagrid' => [
                            ...
                            'email'       => 'Электронная почта',
                            'flags'       => 'Флаги',
                            'flags-value' => 'Всего флагов - :count',
                            'id'          => 'ID',
                            'id-value'    => 'ID - :id',
                            'name'        => 'Имя',
