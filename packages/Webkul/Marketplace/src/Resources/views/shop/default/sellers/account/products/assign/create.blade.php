<x-marketplace::shop.layouts>
    ...
    <x-marketplace::shop.form
        :action="route('marketplace.account.products.assign.store', request()->route()->id)"
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                <div class="rounded border p-5">
                    ...
                    @include('marketplace::shop.sellers.account.products.edit.images', ['product' => []])

                    @include('marketplace::shop.sellers.account.products.edit.videos', ['product' => []])
