...
@if ($inputType == 'checkbox')
    ...
    <x-marketplace::shop.tree.checkbox />
@else
    <!-- Tree Radio Component -->
    <x-marketplace::shop.tree.radio />
@endif
                ...
                generateToggleIconComponent(props) {
                    return this.$h('i', {
                        ...
                        onClick: (selection) => {
                            ...
                            selection.srcElement.classList.toggle('mp-arrow-down-icon', !selection.srcElement.classList.contains('mp-arrow-down-icon'));
                            selection.srcElement.classList.toggle('mp-arrow-right-icon', !selection.srcElement.classList.contains('mp-arrow-right-icon'));
                        },
                    });
                },
                            ...
                            this.$h(
                                'div', {
                                    ...
                                    this.generateToggleIconComponent({
                                        class: [
                                            hasChildren ? 'mp-arrow-down-icon' : '',
                                            'text-2xl rounded-md cursor-pointer transition-all hover:bg-gray-100'
                                        ],
                                    }),

                                    this.generateFolderIconComponent({
                                        class: [
                                            hasChildren ? 'icon-folder' : 'mp-file-attribute-icon',
