...
@pushOnce('scripts')
    <script type="text/x-template" id="v-downloadable-links-template">
        <div class="box-shadow relative mt-2.5 rounded bg-white dark:bg-gray-900">
            <!-- Panel Header -->
            ...
            >
                ...
                >
                    <template #item="{ element, index }">
                        <div class="flex cursor-pointer justify-between gap-2.5 border-b border-slate-300 p-4 dark:border-gray-800">
                            <!-- Hidden Input -->
                            ...
                            <div class="flex gap-2.5">
                                <!-- Drag Icon -->
                                <i class="text-xl text-gray-600 transition-all pointer-events-none icon-drag dark:text-gray-300"></i>
                                    ...
                                    <template v-if="selectedLink.type == 'file'">
                                        <x-admin::form.control-group class="flex-1">
                                            ...
                                            <input
                                                type="file"
                                                name="file"
                                                class="flex w-full px-3 py-1 text-sm text-gray-600 transition-all border rounded-md min-h-10 hover:border-gray-400 dark:text-gray-300"
    ...
    <script type="text/x-template" id="v-downloadable-samples-template">
        <div class="relative bg-white rounded box-shadow dark:bg-gray-900">
            <!-- Panel Header -->
            <div class="mb-2.5 flex justify-between gap-5 p-4">
                <div class="flex flex-col gap-2">
                    <p class="text-base font-semibold text-gray-800 dark:text-white">
