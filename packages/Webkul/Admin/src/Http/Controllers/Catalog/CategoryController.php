...
class CategoryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin::catalog.categories.create', compact('categories', 'attributes', 'tags'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('admin::catalog.categories.edit', compact('category', 'categories', 'attributes', 'tags'));
    }
