...
use Webkul\Admin\Http\Controllers\Catalog\TagController;
...
Route::group(['middleware' => ['admin'], 'prefix' => config('app.admin_url')], function () {
    Route::prefix('catalog')->group(function () {
        ...
        Route::controller(TagController::class)->prefix('tags')->group(function () {
            Route::get('', 'index')->name('admin.catalog.tags.index');

            Route::get('create', 'create')->name('admin.catalog.tags.create');

            Route::post('create', 'store')->name('admin.catalog.tags.store');

            Route::get('edit/{id}', 'edit')->name('admin.catalog.tags.edit');

            Route::put('edit/{id}', 'update')->name('admin.catalog.tags.update');

            Route::delete('edit/{id}', 'destroy')->name('admin.catalog.tags.delete');

            Route::post('mass-delete', 'massDestroy')->name('admin.catalog.tags.mass_delete');

            Route::post('mass-update', 'massUpdate')->name('admin.catalog.tags.mass_update');

            Route::get('search', 'search')->name('admin.catalog.tags.search');

            Route::get('tree', 'tree')->name('admin.catalog.tags.tree');
        });
